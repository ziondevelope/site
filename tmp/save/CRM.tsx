                ...
                <div className="flex justify-center items-center py-5 bg-gray-50">
                  {(() => {
                    ...
                    return sortedStages.map((stage, index) => {
                      const isActive = lead.stageId === stage.id;
                      ...
                      if (isActive) {
                        bgColor = '#3b82f6'; // active blue
                        textColor = 'text-white';
                      } else if (isCompleted) {
                        bgColor = '#3b82f6'; // completed blue
                        textColor = 'text-white';
                      }
                      
                      if (index < sortedStages.length - 1) {
                        lineColor = isActive || isCompleted ? '#3b82f6' : '#E5E7EB';
                      }
                      ...
                      return (
                        <div key={stage.id} className="flex items-center">
                          {/* Circle with number */}
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center ${textColor} cursor-pointer`}
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-800">
                          {lead.propertyType === 'apartment' ? 'Apartamento' :
                           ...
                           lead.propertyType === 'commercial' ? 'Comercial' : 'Apartamento'}
                        </p>
                      </div>
                      
                      <div className="mb-4">
                        <p className="text-sm font-medium text-gray-600">Região:</p>
                        <p className="text-sm text-gray-800">{lead.region || "Rio de Janeiro"}</p>
                      </div>
