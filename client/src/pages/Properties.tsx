                      ...
                      <div className="flex items-center space-x-2">
                        {property.area > 0 && (
                          <div className="flex items-center" title={`Área: ${property.area}m²`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="M3 3v18h18"/><path d="M3 15h18"/><path d="M15 3v18"/></svg>
                            <span className="ml-1 text-xs text-gray-600">{property.area}m²</span>
                          </div>
                        )}
                        {property.bedrooms > 0 && (
                          <div className="flex items-center" title={`Quartos: ${property.bedrooms}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="M2 9V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5"/><path d="M2 11v5a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a2 2 0 0 0-4 0v2H6v-2a2 2 0 0 0-4 0Z"/><path d="M4 18v2"/><path d="M20 18v2"/><path d="M12 4v9"/></svg>
                            <span className="ml-1 text-xs text-gray-600">{property.bedrooms}</span>
                          </div>
                        )}
                        {property.suites > 0 && (
                          <div className="flex items-center" title={`Suítes: ${property.suites}`}>
                            ...
                            <span className="ml-1 text-xs text-gray-600">{property.suites}</span>
                          </div>
                        )}
                        {property.bathrooms > 0 && (
                          <div className="flex items-center" title={`Banheiros: ${property.bathrooms}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="M7 21h10V11H7zM7 11l5-7 5 7M4 11h16"/><path d="M4 11v1a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4v-1"/></svg>
                            <span className="ml-1 text-xs text-gray-600">{property.bathrooms}</span>
                          </div>
                        )}
                        {property.parkingSpots > 0 && (
                          <div className="flex items-center" title={`Vagas: ${property.parkingSpots}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="M3 12v3a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3v-3"/><path d="M14 15V8a1.5 1.5 0 0 0-3 0v7"/><path d="M17 15V8a1.5 1.5 0 0 0-3 0v7"/><path d="M6 15V8a1.5 1.5 0 0 1 3 0v7"/><path d="M12 4C6.5 4 2 5.5 2 9v1h20V9c0-3.5-4.5-5-10-5Z"/></svg>
                            <span className="ml-1 text-xs text-gray-600">{property.parkingSpots}</span>
                          </div>
                        )}
                      </div>
                    </TableCell>
