...
interface ImageUploadProps {
  ...
  label?: string;
  // Props compatíveis com react-hook-form
  value?: string;
...
export function ImageUpload({ 
  ...
  // Use value como currentImage se estiver definido
  ...
  const handleFileChange = async (e: ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      try {
        ...
        alert('Ocorreu um erro ao processar a imagem. Tente novamente com uma imagem menor ou em outro formato.');
      }
    } catch (error) {
      console.error('Erro ao processar a imagem:', error);
      alert('Ocorreu um erro ao selecionar a imagem. Tente novamente.');
    } finally {
      setIsLoading(false);
    }
  };
