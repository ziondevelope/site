...
const PropertyCard: React.FC<PropertyCardProps> = ({ property, onClick, primaryColor, buttonTextColor }) => {
  ...
  return (
    <div className="group flex-shrink-0 w-full md:w-[calc(25%-12px)] rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 bg-white">
        ...
        <div className="relative">
          <div className="overflow-hidden">
            <div 
              ...
              style={{ 
                transform: `translateX(-${currentSlide * (100 + (16 * visibleProperties / slideWidth))}%)` 
              }}
            >
